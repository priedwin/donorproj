...
router.post('/addDonorBloodBagDetails',DonorController.saveDonorBloodBagDetails)
router.get('/getDonorBloodBagDetails/:donor_bank',DonorController.getDonorBankBagListDetails)
